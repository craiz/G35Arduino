...
#if DEBUG_LIGHT_PROGRAM_MEOSIMPLEXNOISE
...
MEOSimplexNoise::MEOSimplexNoise(G35& g35)
  : LightProgram(g35),
    rMult_(1.0),
    gMult_(1.0),
    bMult_(1.0),
...
// This = not work
    ...
    light_count_t node_spacing = light_count_ / numSpacing;
    ...
    float xoffset = 0.0;
    for (light_count_t i = 0; i <= light_count_; i = i + node_spacing)
    {
        xoffset += spaceinc_;
