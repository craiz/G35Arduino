...
bool Stereo::Initialize(pattern_t pattern, option_t option, delay_t delay)
{
...
uint32_t Stereo::Do()
{
    ...
    {
        color_t color = i == peak_i ? COLOR_RED : COLOR_BLACK;
